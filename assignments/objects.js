...
const parent = {
  name: "Susan",
  age: 70,
  speak: function(){console.log("Hey im the parent speaking")},

  child: {
    name: "George",
    age: 50,
    speak: function(){console.log("Hey im the child speaking")},

    grandchild: {
      name: "Sam",
      age: 30,
      speak: function(){console.log("Hey im the grandchild speaking")}
    }//grandchild
  }//child
}//parent
